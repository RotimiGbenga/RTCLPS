...
const services = [
  {
    icon: <AuditingIcon className="w-12 h-12 text-blue-600" />,
  ...
  {
    icon: <BookkeepingIcon className="w-12 h-12 text-blue-600" />,
    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-600">Our Core Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="group bg-white p-8 rounded-lg shadow-lg text-center hover:shadow-2xl hover:-translate-y-3 transition-all duration-300">
              <div className="inline-block bg-blue-100 p-4 rounded-full mb-4 transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:bg-blue-200">
                {service.icon}
              </div>
