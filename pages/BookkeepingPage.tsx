    ...
    <div className="bg-white">
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6">
          <h1 className="text-4xl font-bold text-orange-600 mb-2">Book-Keeping & Financial Statements Preparation</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Precision Records for a Clearer Future</h2>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Benefits of Professional Financial Services</h2>
            ...
            <div>
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Our Flexible Services</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-orange-600">Daily</h3>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-orange-600">Weekly</h3>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-orange-600">Monthly</h3>
