    ...
    <div className="bg-white">
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6">
          <h1 className="text-4xl font-bold text-orange-600 mb-2">Professional Training</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Unlock the Full Potential of Your Software</h2>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Customized Training Programs</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="text-3xl font-bold text-orange-600 mb-4">Flexible Delivery Options</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                We offer training in the format that works best for your business and schedule.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-orange-600">On-Site Training</h3>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-orange-600">Remote Training</h3>
