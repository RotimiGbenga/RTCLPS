          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {categories.map(category => (
              <button
                ...
                className={`px-5 py-2 rounded-full font-semibold text-sm transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filteredServices.map((service, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-lg hover:shadow-lg transition-shadow duration-300 flex flex-col">
                ...
                <a 
                  href={service.link} 
                  className="font-semibold text-blue-600 hover:text-blue-800 transition-colors mt-auto self-start"
                >
                  Learn More &rarr;
                </a>
              </div>
